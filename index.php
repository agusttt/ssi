                ...
                <div class="wrp-mobile-item">
                    <div class="accordion accordionMenu" id="accordionMenu">
                        ...
                        <div id="collapseMenu2" class="collapse" aria-labelledby="headingOne"
                            data-bs-parent="#accordionMenu">
                            <ul class="sub-menu-child">
                                <li><a href="javascript: void(0)">Mixed-use Buildings</a></li>
                    ...
                    <div class="wrp-item-projects">
                        <a href="javascript: void(0)">
                            <div class="card-home-projects">
                                <img src="assets/images/projects-home-mixed-use-building.jpg" alt="Mixed-use Buildings portfolio projects showcase">
                            </div>
                    ...
                    <div class="container centered-container">
                                    ...
                                    <div class="contain-contacts">
                                        <div class="phone-whatasapp">
                                            ...
                                            <div class="conatains-link">
                                                <a href="tel:(62-21) 5367-5511" target="_blank">(62-21) 5367-5511,</a>
                                                <a href="tel:(62-21) 534-7070" target="_blank">534-7070</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>         
                                ...
                                <div class="w-100">
                                    <div class="contain-contacts">
                                        <div class="phone-whatasapp">
                                            ...
                                            <div class="conatains-link">
                                                <a href="mailto:ssi@ssi-web.com" target="_blank">ssi@ssi-web.com</a>                                                
                                            </div>
                                        </div>
                                    </div>
                                </div>           
                        ...
                        <div class="footer-row-two">
                            ...
                            <div class="footer-logo">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 282.4 480" style="enable-background:new 0 0 282.4 480;" xml:space="preserve">
                                    <g>
                                        <path class="st0" d="M184.7,99.8c-45.3,45.3-45.3,118.9,0,163.8l5.8,5.8c16,16,16,42.6,0,58.6l-40.8,40.8v105.2l93.6-93.6
                                            c45.3-45.3,45.3-118.9,0-163.8l-5.8-5.8c-16-16-16-42.6,0-58.6l40.8-40.8V6.1C278.3,6.1,184.7,99.8,184.7,99.8z"></path>
                                        <path class="st0" d="M97.7,99.8L4.1,6.1v105.2l40.8,40.8c16,16,16,42.6,0,58.6l-5.8,5.8c-45.3,45.3-45.3,118.9,0,163.8l93.6,93.6
                                            V368.7l-40.8-40.8c-16-16-16-42.6,0-58.6l5.8-5.8C143,218.3,143,144.6,97.7,99.8C97.7,99.8,97.7,99.8,97.7,99.8z"></path>
                                        <path class="st0" d="M144.3,6.1c-16.9,0-32,10.2-38.2,25.7s-2.7,33.3,8.9,45.3c12,12,29.7,15.5,45.3,8.9
                                            c15.5-6.2,25.7-21.7,25.7-38.2S167.4,6.1,144.3,6.1z"></path>
                                    </g>
                                </svg>
                            </div>
                        </div>
